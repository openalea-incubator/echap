...
def HS_number():
    SSI = {'Mercia': pandas.DataFrame({'TT':[485.90,1159.15,1304.10,1732.10,1818.05,1959.55,2108.65], '11':[3.6,9.4,10.5,11,11,11,11], '12':[3.6,9.9,11.3,12.0,12.0,12.0,12.0], '13':[4.4,10.4,11.9,13,13,13,13], 'mediane':[3.6,9.9,11.3,12,12,12,12]}),
         ...
         'Tremie13': pandas.DataFrame({'TT':[565.8,915,1048.8,1284.4,1351.4,1414.7,1545.7,1639,1762.5,1883.7], '11':[4.3,8.1,9.6,11,11,11,11,11,11,11], '12':[4.5,8.8,10,12,12,12,12,12,12,12], 'mediane':[2.2,6.95,8.25,9.35,9.4,9.55,9.95,10.5,10.85,11.3]})}
    return SSI
