...
def test_adel(TT_stop):
    ...
    res.var.TT_stop =  plot_statistics(axstat, nplants, domain_area)
    return res.var.TT_stop, tx
...
if __name__=="__main__":
    TT_stop = [TT_stop for TT_stop in TT_stop_list]
    print TT_stop
    p = mp.Pool(4)
    p.map(test_adel,TT_stop)
