...
- The meteorological database that will be that for Grignon or other in Paris region : temperature, PAR (or Rg), rain (cf TODO list)
What about UV ? question to WPP5 = how to estimate the input in UV radiation from the Meteorological database
