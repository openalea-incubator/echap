...
def _caribu_call(g, directions, opt=None, domain=None, convUnit=None):
    ...
    c_scene = CaribuScene(scene=g, light=sources, opt=opt, pattern=domain)
...
def caribu_star(g, directions=1, output_by_triangle=False, domain=None, convUnit=0.01):
    ...
    c_scene, raw, aggregated = _caribu_call(g, str(directions), domain=domain, convUnit=convUnit)
...
def caribu_rain_star(g, output_by_triangle=False, domain=None, convUnit=0.01, dt=1):
    ...
    rain_star, rain_exposed_area = caribu_star(g, directions=1, output_by_triangle=output_by_triangle,
