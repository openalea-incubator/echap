...
Test results have to be checked in the created temp directory. 
...
import alinea.echap.ADASWheatReconstruction.thermal_time
...
def setup_module():
    ...
    start = pandas.datetime(1998, 9, 1)
    end = pandas.datetime(1999, 8, 31)
    ...
    start = pandas.datetime(1999, 9, 1)
    end = pandas.datetime(2000, 8, 31)
